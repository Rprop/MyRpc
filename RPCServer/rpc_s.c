...
/* Standard interface: MPQ, ver. 1.0,
   GUID={0xF6D8F144,0x8246,0x4D2F,{0xBF,0xE9,0x6A,0x29,0xE1,0x45,0xB2,0xA9}} */
...
static const RPC_SERVER_INTERFACE MPQ___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0xF6D8F144,0x8246,0x4D2F,{0xBF,0xE9,0x6A,0x29,0xE1,0x45,0xB2,0xA9}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&MPQ_v1_0_DispatchTable,
    0,
    0,
    0,
    &MPQ_ServerInfo,
...
RPC_IF_HANDLE MPQ_v1_0_s_ifspec = (RPC_IF_HANDLE)& MPQ___RpcServerInterface;

extern const MIDL_STUB_DESC MPQ_StubDesc;
...
static const unsigned short MPQ_FormatStringOffsetTable[] =
    {
    0,
    36
    };
...
static const MIDL_STUB_DESC MPQ_StubDesc = 
    {
    (void *)& MPQ___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION MPQ_table[] =
    {
    NdrAsyncServerCall,
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE MPQ_v1_0_DispatchTable = 
    {
    2,
    (RPC_DISPATCH_FUNCTION*)MPQ_table
    };

static const SERVER_ROUTINE MPQ_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)JoinTask,
    (SERVER_ROUTINE)Shutdown
    };

static const MIDL_SERVER_INFO MPQ_ServerInfo = 
    {
    &MPQ_StubDesc,
    MPQ_ServerRoutineTable,
    rpc__MIDL_ProcFormatString.Format,
    MPQ_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
