...
handle_t MPQ_BindingHandle;


static const RPC_CLIENT_INTERFACE MPQ___RpcClientInterface =
    {
...
RPC_IF_HANDLE MPQ_v1_0_c_ifspec = (RPC_IF_HANDLE)& MPQ___RpcClientInterface;

extern const MIDL_STUB_DESC MPQ_StubDesc;

static RPC_BINDING_HANDLE MPQ__MIDL_AutoBindHandle;
    ...
    /* [out] */ int *res)
{
    ...
    NdrAsyncClientCall(
                      ( PMIDL_STUB_DESC  )&MPQ_StubDesc,
                      (PFORMAT_STRING) &rpc__MIDL_ProcFormatString.Format[0],
                      ( unsigned char * )&JoinTask_AsyncHandle);
...
void Shutdown( void)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&MPQ_StubDesc,
                  (PFORMAT_STRING) &rpc__MIDL_ProcFormatString.Format[36],
                  ( unsigned char * )0);
